...
# Set DPI awareness at the beginning of the program for Windows 8.1 and later
...
def select_folder():
    bi = BROWSEINFO()
    bi.lpszTitle = "Choose the base directory."
...
def select_file():
    ...
    ofn.nMaxFile = 260
    ofn.lpstrFilter = "J2TEAMS Cookies file (*.json)\0*.json\0"
    ofn.nFilterIndex = 1
    ofn.lpstrTitle = "Choose www.xiaohongshu.com cookies"
